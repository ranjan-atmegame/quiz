...
const CustomeCheck = (props) =>{
    const {inputId, labelFor, inputName, inputType, inputClass, labelClass, inputValue} = props;
return(
    //For radio
    ...
    <div>
        <div>
            <input id={inputId} className={styles[inputClass]} name={inputName} type={inputType}  />
            <label htmlFor={labelFor} className={styles[labelClass]}>{inputValue}</label>
        </div>

...
export default function RewardTimer({ onTimerOver, shouldStopTimer }) {
  const [timer, setTimer] = useState(0);
  const [seconds, setSeconds] = useState(REWARD_TIME);

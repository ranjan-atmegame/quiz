...
export default function EmptyDetail({ isSignedIn }) {
  return (
    <>
      <div className={styles.playNow}>
        ...
        <p className={`${styles.shine} ${styles.emptyH1}`}>
          <span className={styles.emptyVisibility}>
            You’ve got {QUIZ_TIME} seconds to answer all questions. Answer as
            many questions as you can. Entry fee will be{' '}
          </span>
      ...
      <JoinButton isSignedIn={isSignedIn} href="" />{' '}
    </>
  );
}
